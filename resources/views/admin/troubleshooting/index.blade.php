...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="{{ action('Admin\TroubleshootController@add') }}" role="button" class="btn btn-primary">事例の作成</a>
            </div>
            <div class="col-md-8">
                        ...
                        <tbody>
                            @foreach($posts as $troubleshoot)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                        <a href="{{ action('Admin\TroubleshootController@show', $troubleshoot->id) }}" role="button" class="btn btn-primary">詳細</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
