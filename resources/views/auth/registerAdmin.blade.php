            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="form-group row">
                            <label for="belongs" class="col-md-4 col-form-label text-md-right">{{ __('belongs') }}</label>

                            <div class="col-md-6">
                                <input id="belongs" type="text" class="form-control @error('belongs') is-invalid @enderror" name="belongs" value="{{ old('belongs') }}" required autocomplete="belongs" autofocus>
